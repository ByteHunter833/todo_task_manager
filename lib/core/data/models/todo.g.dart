...
Todo _todoDeserialize(
  ...
  final object = Todo();
  object.category =
      _TodocategoryValueEnumMap[reader.readStringOrNull(offsets[0])] ??
          TodoCategory.work;
  ...
  object.priority =
      _TodopriorityValueEnumMap[reader.readStringOrNull(offsets[6])] ??
          TodoPriority.low;
...
const _TodocategoryValueEnumMap = {
  r'work': TodoCategory.work,
  r'personal': TodoCategory.personal,
  r'health': TodoCategory.health,
  r'shopping': TodoCategory.shopping,
  r'education': TodoCategory.education,
  r'finance': TodoCategory.finance,
};
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> snoozedUntilIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> snoozedUntilIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'snoozedUntil',
      ));
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> snoozedUntilEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'snoozedUntil',
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> snoozedUntilGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> snoozedUntilLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> snoozedUntilBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoQuerySortBy on QueryBuilder<Todo, Todo, QSortBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> sortBySnoozedUntil() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'snoozedUntil', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> sortBySnoozedUntilDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoQuerySortThenBy on QueryBuilder<Todo, Todo, QSortThenBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> thenBySnoozedUntil() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'snoozedUntil', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> thenBySnoozedUntilDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'snoozedUntil', Sort.desc);
    });
  }
...
extension TodoQueryWhereDistinct on QueryBuilder<Todo, Todo, QDistinct> {
  ...
  QueryBuilder<Todo, Todo, QDistinct> distinctBySnoozedUntil() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, DateTime?, QQueryOperations> snoozedUntilProperty() {
    return QueryBuilder.apply(this, (query) {
